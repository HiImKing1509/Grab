        ...
        public void showAlert(string msg, enmType type)
        {
            ...
            switch (type)
            {
                case enmType.Success:
                    PictureBox_Icon.Image = (Bitmap)Assets.Variables.ResourcesManager.rm_grab_icon.GetObject("Success");
                    BackColor = Color.Green;
                    break;
                case enmType.Error:
                    PictureBox_Icon.Image = (Bitmap)Assets.Variables.ResourcesManager.rm_grab_icon.GetObject("Error");
                    BackColor = Color.Red;
                    break;
            }
